...
public class Sprite 
{
    ...
    public void Draw(SpriteBatch spriteBatch, Vector2 position, Vector2 origin,SpriteEffects effect)
    {
        Region.Draw(spriteBatch, position, Color, Rotation, origin, Scale, effect, LayerDepth);
    }
